...
HD_PWD='C:/Users/user/Desktop/Юнусов/func_chemas/Work/func_chema/posege_project/posege_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log posege_counter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source posege_counter.tcl
